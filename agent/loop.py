    ...
    def _compact_memory(self):
        ...
        if len(self.history) > COMPACTION_THRESHOLD:
            ...
            summary_prompt = [
                ...
                {"role": "user", "content": f"Please summarize this intermediate history:\n\n{middle_text}"}
            ]
            ...
            try:
                ...
                summary_text = "The agent explored the codebase and ran tools. (Summarization failed)"
...
def run_agent(issue_description: str, model: str = DEFAULT_MODEL, instance_id: str = None) -> List[Dict[str, Any]]:
